module.exports = {
    "bot": {
        "version": "1.3.3", // Current bot version
        ...
        "gameMessage":"Beyondcoin.io | +help", // Message under the bot name in the discord user list
        ...
        "botID": "", // Bot Discord ID - important else it react to own messages 
        "adminIDs": [ "420583786053369868", "XXX", "XXX" ], // This discrod user IDs are able to use admin commands and bypass cooldowns
        "moderatorIDs": [ "420583786053369868" ], // This discrod user IDs are able to use moderator commands and bypass cooldowns
        "vipGroupName": "Beyondcoin Team", // Users of this group are able to use vip commands and bypass cooldowns
        "respondChannelIDs": [ "636067676552429568" ], // Discord server channel IDs the bot does listen to
    ...
    "wallet":{
        ...
        "port": "10332", // Wallet port
        // TODO ENCRYPTION KEY FOR WALLET
        "coinSymbol": "Beyondcoin", // Coin name
        "coinSymbolShort": "BYND", // Coin name
        "thumbnailIcon": "https://beyondcoin.io/beyondcoin.png", // Thumbnail icon for all messages (need to get enabled first in code to work = not ready)
        ...
        "explorerLinkAddress": "https://byndexplorer.com/address/", // Explorer link address for addresses
        "explorerLinkTransaction": "https://byndexplorer.com/tx/", // Explorer link transaction
        ...
        "donateAddress":"BKJKT5ZpdxppVa8LDNxCYnfHHNNAA1Xdi1" // Address for donations
    },
    ...
    "messages": { // Some messages contain markdown -> http://markdown.de
        ...
        "donate": {
            "title":"Donate",
            "address":"Address",
            "description":"Feel free to send a tip to the following address if you want to support the bot creator. Thank you! :)"
        },
        "drop": {
